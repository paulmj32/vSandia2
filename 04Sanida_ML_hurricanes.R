...
plot_filtering_estimates2 <- function(df) {
  p = ggplot() + 
    ...
    scale_alpha_manual(
      ...
      name = element_blank()) + 
    ylab("Severe Outages due to Hurricanes (per year)") + 
...
pdp2 = pdp::partial(final_obj, pred.var = "DEM_max", ice = F, center = F,
                    plot = T, rug= T, alpha = 0.1, #plot.engine = "ggplot2",
                    train = X_train, type = "regression")
pdp3= pdp::partial(final_obj, pred.var = "QBLACK", ice = F, center = F,
                   plot = T, rug= T, alpha = 0.1, #plot.engine = "ggplot2",
                   train = X_train, type = "regression")
pdp4 = pdp::partial(final_obj, pred.var = "DEM_sd", ice = F, center = F,
                    plot = T, rug= T, alpha = 0.1, #plot.engine = "ggplot2",
                    train = X_train, type = "regression")
pdp5 = pdp::partial(final_obj, pred.var = "QMOHO", ice = F, center = F,
                    plot = T, rug= T, alpha = 0.1, #plot.engine = "ggplot2",
                    train = X_train, type = "regression")
pdp6 = pdp::partial(final_obj, pred.var = "EDEQUITY", ice = F, center = F,
                    plot = T, rug= T, alpha = 0.1, #plot.engine = "ggplot2",
                    train = X_train, type = "regression")
pdp7 = pdp::partial(final_obj, pred.var = "DEM_min", ice = F, center = F,
                    plot = T, rug= T, alpha = 0.1, #plot.engine = "ggplot2",
                    train = X_train, type = "regression")
pdp8 = pdp::partial(final_obj, pred.var = "QHLTH", ice = F, center = F,
                    plot = T, rug= T, alpha = 0.1, #plot.engine = "ggplot2",
                    train = X_train, type = "regression")
